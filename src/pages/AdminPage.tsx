...
import { Home, Users, Building, TrendingUp } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card className="text-center">
            ...
            <p className="text-xs text-gray-500">Villas total</p>
          </Card>
          <Card className="text-center">
          ...
          <Card className="text-center">
            <div className="flex items-center justify-center w-10 h-10 bg-amber-100 rounded-xl mx-auto mb-2">
              <span className="text-amber-700 font-bold text-sm">MRR</span>
            </div>
            <p className="text-2xl font-bold text-gray-900">
              {byPlan('starter') * 29 + byPlan('pro') * 59 + byPlan('agence') * 99}€
            </p>
            <p className="text-xs text-gray-500">Revenu mensuel estimé</p>
          </Card>
        </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100 bg-gray-50 text-left">
                  ...
                  <th className="px-5 py-3 font-semibold text-gray-500 text-right">Villas</th>
              ...
              <tbody className="divide-y divide-gray-50">
                ...
                {tenants.length === 0 && (
                  <tr><td colSpan={5} className="px-5 py-10 text-center text-gray-400">Aucun tenant</td></tr>
                )}
              </tbody>
            </table>
          </div>
